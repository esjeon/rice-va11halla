...
static const int tbpad              = 16;       /* sum of top and bottom padding for text */
static const int lrpad              = 34;       /* sum of left and right padding for text */
...
/* alpha */
static const unsigned int alpha_scheme[3] = { 0xff, 0xd8, 0xff };

/* tagging */
static const char *tags[] = {
	"\xEF\x80\x93 ", /* cog */
	"2", "3", "4", "5" , "6" , "7",
	"\xEF\x83\xA0 ", /* envelope */
	"\xEF\x83\x82 ", /* cloud */
};
...
static const Layout layouts[] = {
	...
	{ "\xEF\x83\x9B" , tile },    /* icon: columns */
	{ "\xEF\x8B\x92" , NULL },    /* icon: window-restore */
	{ "\xEF\x8B\x90" , monocle }, /* icon: window-maximize */
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-nb", col_normb, "-nf", col_normf, "-sb", col_highb, "-sf", col_highf, NULL };
